class Jar:
    ...
    def deposit(self, n):
        ...
        if self._cookies + n > self._capacity:
            raise ValueError("Cannot deposit more cookies than the capacity of the jar")
        self._cookies += n
    ...
    def withdraw(self, n):
        ...
        if self._cookies - n < 0:
            raise ValueError("Cannot withdraw more cookies than the current number of cookies in the jar")
        self._cookies -= n
