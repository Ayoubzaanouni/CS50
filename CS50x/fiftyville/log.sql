...
SELECT * FROM bakery_security_logs
   WHERE hour = 16 AND minute = 36;

SELECT * FROM bakery_security_logs
   WHERE license_plate = "X4G3938";

SELECT * FROM people
   WHERE license_plate = "X4G3938";

 SELECT * FROM passengers
   WHERE passport_number = 5310124622;
...
SELECT * FROM bank_accounts
   WHERE person_id = 630782;

SELECT * FROM atm_transactions
   WHERE account_number = (
   SELECT account_number FROM bank_accounts WHERE person_id = (SELECT id FROM people WHERE license_plate = "X4G3938"));

SELECT * FROM phone_calls
   WHERE caller = "(814) 555-5180" OR receiver = "(814) 555-5180";
